    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="short-sescription">
                ...
                <p class="lead">Timeline is a simple web application where you can add your own events.</br>
                When you are login you can add events and categories for this events.</br>
                When you are login as an admin you can also see users list.</p>
